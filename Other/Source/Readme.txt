...
user in an INI file next to BYONDPortable.exe called BYONDPortable.ini.
...
copy AppNamePortable.ini from this directory to BYONDPortable.ini next to
BYONDPortable.exe. The options in the INI file are as follows:
